...
\item inner-to-outer $X \rightarrow Y$. Let $A$ be the array defined at $X$. If the dimensionality $A$ is greater than its canonical dimensionality, then add \emph{drop\_dim(...)} at $Y$, as in Basic Vectorization. Otherwise, do nothing. 
...
Consider MPC-source of Histogram after removal of infeasible edges and MUX refinement:
