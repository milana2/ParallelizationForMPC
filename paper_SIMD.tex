...
\COMMENT {Phase 3: Dimensionality reduction: remove unnecessary dimensionality. \ana{Better draft! Needs a bit more work.}}
...
\STATE {if $i$ is a dead dimension on exit from stmt $X[...i...] = ...$, remove $i$ from $X$} 
