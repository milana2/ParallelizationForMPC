...
\ana{Commenting out this section to have paper compile on Github. Will revert!}
%\begin{comment}
...
\ana{Commented out this section to have paper compile on Github. Will revert!}
...
\[\begin{array}{l}
\gamma(\x[i,J,k] = \y[i,J,k] \; \mathit{op\_SIMD} \; \z[i,J,k]) = \\ 
