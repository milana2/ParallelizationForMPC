...
\begin{figure*}[htbp]
\centering
\include{graphs/all-hist-OnlineSetupTimesec}
...
\begin{figure*}[htbp]
\centering
\include{graphs/all-hist-CommunicationMiB}
...
\begin{figure*}[htbp]
\centering
\include{graphs/all-hist-CircuitGenerationTimesec}
...
\begin{figure*}[htbp]
\centering
\include{graphs/all-hist-TotalGates}
...
\begin{figure*}[htbp]
\centering
\include{graphs/all-hist-SetupTimesec}
