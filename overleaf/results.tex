...
{\sf result += mult\_unsimdified[i];} while our loop generated and ran {\sf result[i] = prev + mult\_unsimdified[i];}. 
...
MOTION does the standard divide-and-conquer accumulation. It also illustrates the limitation of higher-level AST analysis --- while 
...
code was used. \ana{This is not true, have to tone down.} We conjecture that MPC source, as a more straight-forward representation will
