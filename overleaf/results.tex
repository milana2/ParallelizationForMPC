...
limitation of our current implementation. Recall that the Phase 3 of Vectorization, in~\secref{sec:vectorization}, which we have not implemented yet, gets rid of redundant 
