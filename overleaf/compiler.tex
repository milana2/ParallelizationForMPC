...
This section outlines the front end, \secref{sec:vectorization} describes analysis on MPC Source and backend-independent vectorization 
...
It is a standard restriction in MPC that computation is bounded~\cite{NDSS:DemSchZoh15,CCS:BDKKS18}.
