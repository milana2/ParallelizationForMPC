...
The rest of the paper is organized as follows. Section \secref{sec:overview} presents an overview of the compiler. Section \secref{sec:model} describes our model for cost estimation and argues NP-hardness of optimal scheduling. Section \secref{sec:compiler} details the phases of the compiler and Section \secref{sec:vectorization} focuses in on vectorization. \secref{sec:results} presents the experimental evaluation. Section \secref{sec:related} discusses related work and Section \secref{sec:conclusion} concludes.
