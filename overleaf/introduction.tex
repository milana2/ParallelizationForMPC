...
The rest of the paper is organized as follows. \secref{sec:overview} presents an overview of the compiler. \secref{sec:model} describes our model for cost estimation and argues NP-hardness of optimal scheduling. \secref{sec:compiler} details the phases of the compiler and \secref{sec:vectorization} focuses in on vectorization. \secref{sec:results} presents the experimental evaluation.\secref{sec:related} discusses related work and \secref{sec:conclusion} concludes.
