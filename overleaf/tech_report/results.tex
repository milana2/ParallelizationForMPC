...
%The most closely related work, HyCC~\cite{Buscher:2018}, is a mixing compiler that focuses on mixed protocols, while we run vectorization within a single protocol. 
