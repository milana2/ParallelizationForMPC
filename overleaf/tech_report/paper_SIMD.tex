...
%
\documentclass[sigconf, screen, review, natbib=false, dvipsnames, table]{acmart}
...
\title[Compilation and Backend-Independent Vectorization for Multi-Party Computation]{Compilation and Backend-Independent Vectorization for Multi-Party Computation (Extended Version)}
...
\author{Benjamin Levy and Ben Sherman}
\authornote{Joint first authors.}
\email{{levyb3,shermb}@rpi.edu}
\affiliation{%
...
\maketitle 
\renewcommand{\shortauthors}{Levy and Sherman et al.}
%\thispagestyle{empty}
