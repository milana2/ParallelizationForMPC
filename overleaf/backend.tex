...
\begin{enumerate}
\item Loop counters are always \texttt{plain}. \ben{I removed the reference to array bounds since those are not variables defined in MPC source}
