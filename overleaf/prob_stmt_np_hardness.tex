...
\begin{figure}
  \includegraphics[width=0.6\linewidth]{overleaf/figs_paper_SIMD/sequence_construction.pdf}
...
\begin{figure}
  \includegraphics[width=0.6\linewidth]{overleaf/figs_paper_SIMD/cost_inequality.pdf}
