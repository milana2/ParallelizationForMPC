...
The shortest common supersequence problem~\cite{Vazirani:2010} is as follows: {\it given two or more sequences find the shortest sequence that contains all of the original sequences.} This can be solved in $O(n^k)$ time, where $n$ is the cardinality of the longest sequence and $k$ is the number of sequences. %For our problem $n$ is the maximum length of a sequence and $k$ is the number of instructions of sequences. 
