...
which we expected to be able to solve optimally. \secref{sec:np} show that the problem is NP-hard via a reduction to the 
...
whether $n$ is $10,000$ or just $1$. (This models the cost of preparing and sending a packet from party A to party B for example.) The bottom line is that amortized execution
