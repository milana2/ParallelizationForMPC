...
The example illustrates the two different versions of $\mathit{raise\_dim}$. \texttt{C!0' = raise\_dim(C!0, j, (i:N!0,j:D!0))} reshapes
the read-only input array, while \texttt{sum!3' = drop\_dim(sum!3)} removes the $j$ dimension of \texttt{sum!3}.
